...
// CRITICAL FIX: Read your optimized template and STRIP the local testing script tag
...
const indexHtml = template
    ...
    .replace('{{DESC}}', 'Compare current shipping box prices across Uline, Grainger, The Boxery, and Whitebird instantly. Run a free price check to lock in the lowest volume tiers.')
