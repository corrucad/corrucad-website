...
const indexHtml = template
    ...
    .replace('{{DESC}}', 'Compare current shipping box prices across Uline, Grainger, and The Boxery instantly. Run a free price check to lock in the lowest volume tiers.')
